...
{
$ret=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM users WHERE userEmail='".$_POST['username']."' and password='".md5($_POST['password'])."'");
...
$status=1;
$log=mysqli_query($GLOBALS["___mysqli_ston"], "insert into userlog(uid,username,userip,status) values('".$_SESSION['id']."','".$_SESSION['login']."','$uip','$status')");
...
$uip=$_SERVER['REMOTE_ADDR'];
$status=0;
mysqli_query($GLOBALS["___mysqli_ston"], "insert into userlog(username,userip,status) values('".$_SESSION['login']."','$uip','$status')");
...
$query=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM users WHERE userEmail='$email' and contactNo='$contact'");
$num=mysqli_fetch_array($query);
if($num>0)
{
mysqli_query($GLOBALS["___mysqli_ston"], "update users set password='$password' WHERE userEmail='$email' and contactNo='$contact' ");
